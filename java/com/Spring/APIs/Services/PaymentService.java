...
public class PaymentService {
    ...
    public String createOrder(int userId, BigDecimal totalAmount, List<OrderItem> cartItems) throws RazorpayException {
    	...
    	//Step-1a : Instantiate RazorpayClient using keyid and keysecret(Generated from Razorpay api)
    	// Create Razorpay client
        RazorpayClient razorpayClient = new RazorpayClient(razorpayKeyId, razorpayKeySecret);
        //Step 1b : Create the order request which should contain amount,currency type and reciept
